  ...
  const url = `https://www.google.com/maps/embed/v1/directions?origin=${location.latitude}%2C${location.longitude}&destination=${details.location.address}&key=${key}`
      ...
      <div>
        ...
        <div className="details-container">
          ...
          <InformationComponent title={details.name} type={details.categories[0].shortName} cost={details.price.tier} rating={details.rating} ratingColor={details.ratingColor} message={details.price.message} menu={menu}/>
          {
