            ...
            <div className="login-container">
              ...
              <div className="login">
                <form onSubmit={this.handleSubmit} className="login-form hidden">
                  ...
                  <p className="register-text">No account? <span onClick={this.registerForm} className="register-link">Sign-up</span></p>
                  <button onClick={this.props.googleLogin} className="google"><i className="fab fa-google"></i>GOOGLE</button>
                  <button onClick={this.props.twitterLogin} className="twitter"><i className="fab fa-twitter"></i>TWITTER</button>
                  ...
                  <form onSubmit={this.handleRegister} className="register-form">
                    ...
                    <p className="register-text">Already have an account? <span onClick={this.toggleForm} className="register-link">Login</span></p>
                  </form>
              </div>
            ) : (
              <div className="login">
                <form onSubmit={this.handleSubmit} className="login-form">
                  ...
                  />
                  <button className="submit">LOGIN</button>
                  <p className="register-text">No account? <span onClick={this.toggleForm} className="register-link">Sign-up</span></p>
                  <button onClick={this.props.googleLogin}  className="google"><i className="fab fa-google"></i>GOOGLE</button>
                  <button onClick={this.props.twitterLogin} className="twitter"><i className="fab fa-twitter"></i>TWITTER</button>
                </form>
                  <form onSubmit={this.handleRegister} className="register-form hidden">
                    <h2 className="form-title">REGISTER</h2>
                    <input type="email"
                           value={this.state.email}
                           name="email"
